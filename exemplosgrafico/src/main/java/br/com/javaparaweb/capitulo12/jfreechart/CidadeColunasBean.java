...
public class CidadeColunasBean {
	...
	public CidadeColunasBean() {
		try {
			JFreeChart graficoColunas = ChartFactory.createBarChart("5 cidades mais populosas de SC", "Cidades",
					"População", this.geraDados(), PlotOrientation.VERTICAL, false, true, false);
