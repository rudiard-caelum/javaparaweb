...
public class Cliente {
	...
	public static void main(String[] args) {
		try {
			...
			FinanceiroWS financeiroWS = service
					.getFinanceiroWSPort(new URL("http://localhost:8080/financeiro/webservice/financeiroWS"));
			...
			for (LancamentoItem item : lancamentos) {
				System.out.println("Data: " + item.getData().getTime() + ", Descrição: " + item.getDescricao()
						+ ". Valor: " + item.getValor());
			}
		} catch (Exception e) {
